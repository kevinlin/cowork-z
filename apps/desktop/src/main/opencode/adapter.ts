...
import type { AzureFoundryCredentials } from '@shared';
...
export class OpenCodeAdapter extends EventEmitter<OpenCodeAdapterEvents> {
  ...
  private handleMessage(message: OpenCodeMessage): void {
    ...
    switch (message.type) {
      ...
      case 'tool_use':
        const toolUseMessage = message as import('@shared').OpenCodeToolUseMessage;
        ...
        if (toolDescription) {
          ...
          } as import('@shared').OpenCodeTextMessage;

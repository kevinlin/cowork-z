...
| Apology/Crisis            | Sincere, direct, accountable           |
| Celebration/Success       | Genuine, appreciative, collaborative   |
| Educational/Instructional | Patient, clear, expert                 |
| Sales/Direct response     | Urgency-driven, benefit-focused, clear |

## Style Guide Enforcement

### Common Style Rule Categories

When reviewing content, check for consistency in these categories:

1.  **Punctuation**:
    - Use of the Oxford comma
    - Use of em-dashes vs. en-dashes
    - Punctuation inside or outside quotation marks
    - Use of exclamation points (e.g., "max one per piece")

2.  **Capitalization**:
    - Headline case vs. sentence case for subheadings
    - Capitalization of job titles
    - Capitalization of product features or specific brand terms

3.  **Formatting**:
    - Use of bold for emphasis
    - List formatting (bullets vs. numbers)
    - Date and time formats
    - Number formatting (e.g., spelling out one through nine)

4.  **Perspective**:
    - Use of first person ("we", "us")
    - Addressing the reader directly ("you")
    - Use of third person ("the company", "users")

...
Map content across competitors by topic and format to identify gaps and opportunities.
...
For your company and each competitor, define their positioning statement:

> For [target audience], [product/company] is the [category] that [key benefit/differentiator] because [reason to believe].

### Positioning Map

Plot competitors on a 2x2 matrix using the two most important dimensions for your market (e.g., Price vs. Capability, Ease of Use vs. Power).

### Category Strategy

- **Create a new category**: define and own a new category (high risk, high reward)
- **Reframe the existing category**: change how buyers evaluate the category
- **Win the existing category**: compete directly on recognized criteria
- **Niche within the category**: own a specific segment or use case

## Battlecard Creation

### Battlecard Structure

A competitive battlecard is a one-page reference for sales and marketing teams.
...
- **Strengths**: where they genuinely compete well
- **Weaknesses**: customer complaints, technical limitations, gaps in offering

#### Our Differentiators

- 3-5 specific ways your product or approach is different
- For each: the differentiator, why it matters, and proof
...
Questions to ask prospects that highlight your advantages:

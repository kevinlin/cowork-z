...
2. If not, inform the user they can copy it from the productivity pack or run the `productivity-start` skill.
3. Inform the user: "Run `productivity-start` to set up the full system including the dashboard."

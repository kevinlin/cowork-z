# Start Here: Legal Research Pack

Welcome to the Legal Research Pack! This pack simulates a realistic legal workflow involving contract review and litigation analysis.

## Instructions

1. **Review the Inputs**: Open the `inputs/` folder to see the documents provided.
   - `NDA_TEMPLATE.md`: A standard NDA.
